...
(**[load_map fl tlfl ren] creates a new tilemap representation, with map data
   from the JSON file [fl], and tile data from the JSON file [tlfl]. This is
   done using renderer [ren]. Requires: [fl] and [tlfl] are well-formed JSON
   files generated by Tiled. *)
